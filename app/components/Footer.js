      ...
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
        ...
        <div className="space-y-6">
          ...
          <ul className="flex flex-col gap-4 text-[13px] text-stone-500 font-light">
            ...
            <li><Link href="/product" className="hover:text-black transition-colors">Collections</Link></li>
            <li><Link href="/contact" className="hover:text-black transition-colors">Contact Us</Link></li>
            <li><Link href="/product" className="hover:text-black transition-colors">Exclusive Drops</Link></li>
          </ul>
        </div>
